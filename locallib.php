...
function local_inscricoes_add_cohort_member($contextid, $userid, $role, $edition) {
...
function local_inscricoes_remove_cohort_member($activityid, $contextid, $userid, $role, $edition) {
    global $DB;
